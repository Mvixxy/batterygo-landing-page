        ...
        <div className="flex min-h-screen flex-col justify-center pt-20 pb-12 sm:pt-20 sm:pb-16">
          <div className="max-w-3xl">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:items-center">
              ...
              <a
                href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Halo BatteryGo, saya mau tukar tambah aki")}`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-amber px-5 py-2.5 text-xs font-bold text-navy shadow-xl shadow-amber/30 transition-all hover:scale-105 hover:bg-amber-dark hover:shadow-amber/50 sm:gap-3 sm:px-8 sm:py-4 sm:text-base sm:text-lg"
              >
                <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current sm:h-6 sm:w-6">
