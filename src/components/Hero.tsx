      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex min-h-screen flex-col justify-center pt-20 pb-12 sm:pt-20 sm:pb-16">
          <div className="max-w-3xl">
            {/* Service ribbon */}
            <div className="mb-3 inline-flex rounded-full border border-white/20 bg-white/10 px-3 py-1.5 text-xs font-semibold text-white backdrop-blur-sm sm:mb-4 sm:px-4 sm:py-2 sm:text-sm">
              Melayani pemasangan 24 jam
            </div>

            {/* Eyebrow */}
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-amber/30 bg-amber/10 px-3 py-1.5 sm:mb-6 sm:px-4 sm:py-2">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:mt-8 sm:gap-4 sm:flex-row sm:items-center">
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 rounded-full bg-whatsapp px-6 py-3 text-sm font-bold text-white shadow-xl shadow-whatsapp/30 transition-all hover:scale-105 hover:bg-whatsapp-dark hover:shadow-whatsapp/50 sm:gap-3 sm:px-8 sm:py-4 sm:text-base sm:text-lg"
              >
              ...
              <a
                href="#produk"
                className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-white/20 px-6 py-3 text-sm font-semibold text-white transition-all hover:border-amber/50 hover:text-amber sm:px-8 sm:py-4 sm:text-base sm:text-lg"
              >
                Lihat Produk
