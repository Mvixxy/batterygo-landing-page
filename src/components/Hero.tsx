        ...
        <div className="flex min-h-screen flex-col justify-center pt-20 pb-16">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <a
                href="#produk"
                className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-white/20 px-8 py-4 text-base font-semibold text-white transition-all hover:border-amber/50 hover:text-amber sm:text-lg"
              >
                Lihat Produk
          ...
          {/* Stats bar */}
          <div className="mt-16 grid grid-cols-2 gap-4 rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm sm:grid-cols-4 sm:p-8">
            {stats.map((stat) => (
